...
const state = {
    ...
    favDrugsList: [
        ...
        },
        {
            ...
            name: "Бейодайм",
            form: "набор, ~, (1) -  , 0 шт. в наборе: Перьета (пертузумаб), концентрат для приготовления раствора для инфузий 420 мг/14 мл (флаконы)-1шт; Герцептин (трастузумаб), лиофилизат для приготовления концентрата для приготовления раствора для инфузий 440 мг (флаконы)-1 шт.; в комплекте с растворителем - бактериостатическая вода для инъекций (флаконы)-1 шт. /  поддоны картонные - пачки картонные",
